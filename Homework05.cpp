...
int main() {
	...
	Shader lightingShader = Shader("Shaders/Homework05/vertex_shader_light.glsl", "Shaders/Homework05/fragment_shader_light.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// sets all the lights properties
        lightingShader.setFloatVec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
        lightingShader.setFloatVec3("dirLight.ambient", 0.05f, 0.05f, 0.05f);
        lightingShader.setFloatVec3("dirLight.diffuse", 0.4f, 0.4f, 0.4f);
        lightingShader.setFloatVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);
        // point light 1
        lightingShader.setFloatVec3("pointLights[0].position", pointLightPositions[0].x, pointLightPositions[0].y, pointLightPositions[0].z);
        lightingShader.setFloatVec3("pointLights[0].ambient", 0.05f, 0.05f, 0.05f);
        lightingShader.setFloatVec3("pointLights[0].diffuse", 0.8f, 0.8f, 0.8f);
        lightingShader.setFloatVec3("pointLights[0].specular", 1.0f, 1.0f, 1.0f);
        lightingShader.setFloat("pointLights[0].constant", 1.0f);
        lightingShader.setFloat("pointLights[0].linear", 0.09f);
        lightingShader.setFloat("pointLights[0].quadratic", 0.032f);
        // point light 2
        lightingShader.setFloatVec3("pointLights[1].position", pointLightPositions[1].x, pointLightPositions[1].y, pointLightPositions[1].z);
        lightingShader.setFloatVec3("pointLights[1].ambient", 0.05f, 0.05f, 0.05f);
        lightingShader.setFloatVec3("pointLights[1].diffuse", 0.8f, 0.8f, 0.8f);
        lightingShader.setFloatVec3("pointLights[1].specular", 1.0f, 1.0f, 1.0f);
        lightingShader.setFloat("pointLights[1].constant", 1.0f);
        lightingShader.setFloat("pointLights[1].linear", 0.09f);
        lightingShader.setFloat("pointLights[1].quadratic", 0.032f);
        // point light 3
        lightingShader.setFloatVec3("pointLights[2].position", pointLightPositions[2].x, pointLightPositions[2].y, pointLightPositions[2].z);
        lightingShader.setFloatVec3("pointLights[2].ambient", 0.05f, 0.05f, 0.05f);
        lightingShader.setFloatVec3("pointLights[2].diffuse", 0.8f, 0.8f, 0.8f);
        lightingShader.setFloatVec3("pointLights[2].specular", 1.0f, 1.0f, 1.0f);
        lightingShader.setFloat("pointLights[2].constant", 1.0f);
        lightingShader.setFloat("pointLights[2].linear", 0.09f);
        lightingShader.setFloat("pointLights[2].quadratic", 0.032f);
        // point light 4
        lightingShader.setFloatVec3("pointLights[3].position", pointLightPositions[3].x, pointLightPositions[3].y, pointLightPositions[3].z);
        lightingShader.setFloatVec3("pointLights[3].ambient", 0.05f, 0.05f, 0.05f);
        lightingShader.setFloatVec3("pointLights[3].diffuse", 0.8f, 0.8f, 0.8f);
        lightingShader.setFloatVec3("pointLights[3].specular", 1.0f, 1.0f, 1.0f);
