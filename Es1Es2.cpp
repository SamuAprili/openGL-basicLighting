/* Main project for Lightning exercises with the Phong model (first exercises) */
#include<glad/glad.h>
...
int main() {
	...
	Shader lightingShader = Shader("Shaders/Es1Es2/vertex_shader_light.glsl", "Shaders/Es1Es2/fragment_shader_light.glsl");
	// shader for the source light 
	Shader lightCubeShader = Shader("Shaders/Es1Es2/vertex_shader_cubeLight.glsl", "Shaders/Es1Es2/fragment_shader_cubeLight.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		lightingShader.setFloatVec3("objectColor", 1.0f, 0.0f, 0.31f);
		lightingShader.setFloatVec3("lightColor", 1.0f, 1.0f, 1.0f);
		lightingShader.setFloatVec3("lightPos", lightPos.x, lightPos.y, lightPos.z);
